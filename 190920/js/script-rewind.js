(function($) {
        ...
        if($('.preloader').length) {
            $('.preloader').delay(100).fadeOut(500, function() {
                ...
                if($(".save-the-date").length) {
                    setTimeout(popupSaveTheDateCircle, 15000);
                }
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2020/09/19 14:00:00', function(event) {
            var $this = $(this).html(event.strftime(''
            + '<div class="box"><div>%D</div> <span>Tage</span> </div>'
            + '<div class="box"><div>%H</div> <span>Stunden</span> </div>'
            + '<div class="box"><div>%M</div> <span>Minuten</span> </div>'
            + '<div class="box"><div>%S</div> <span>Sekunden</span> </div>'));
        });
    }
